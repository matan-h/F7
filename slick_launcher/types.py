from PyQt6.QtCore import QCoreApplication, pyqtSignal as _pyqtSignal, QObject
...
if TYPE_CHECKING:
    ...
    class pyqtSignal(Generic[T]): # for some reason, lint,etc. is not working with stock pyqt6.
